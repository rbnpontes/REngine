#pragma once
#define EASTLAllocatorType rengine::EngineEASTLAllocator
#define EASTLAllocatorDefault rengine::get_eastl_allocator

#include <rengine/eastl_allocator.h>
...
namespace rengine {
    ...
    template<typename T, typename Allocator = EngineEASTLAllocator>
