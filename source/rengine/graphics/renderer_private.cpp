	...
	namespace graphics {
		...
		void renderer__reset_state(bool reset_ctx_state) {
			...
			cmd.viewport = { {0, 0}, viewport_size };
                        ...
                        cmd.stencil_test = false;
                        cmd.depth_cmp_func = comparison_function::less_equal;
                        cmd.stencil_cmp_func = comparison_function::always;
                        cmd.depth_pass_op = stencil_op::keep;
                        cmd.stencil_fail_op = stencil_op::keep;
                        cmd.depth_fail_op = stencil_op::keep;
                        cmd.stencil_cmp_mask = 255;
                        cmd.stencil_write_mask = 255;
