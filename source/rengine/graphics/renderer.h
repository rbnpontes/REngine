...
namespace rengine {
	namespace graphics {
		...
		R_EXPORT void renderer_set_texture_2d(c_str slot_name, const texture2d_t& tex_id);
		...
		R_EXPORT void renderer_set_texture_2d(core::hash_t slot, const texture2d_t& tex_id);
		...
		R_EXPORT void renderer_disable_scissors();
