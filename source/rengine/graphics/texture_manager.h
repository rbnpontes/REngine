...
namespace rengine {
	namespace graphics {
		...
		struct texture2d_copy_desc {
			texture2d_t dst_id{ 0 };
			texture2d_t src_id{ 0 };
			u32 dst_mip_level{ 0 };
			u32 src_mip_level{ 0 };
		};
		...
		R_EXPORT texture2d_t texture_mgr_create_tex2d(const texture_create_desc<texture_2d_size>& desc);
		R_EXPORT texture2d_t texture_mgr_create_tex2d(const texture_create_desc<texture_2d_size>& desc, const texture_resource_data& data);
		R_EXPORT texture2d_t texture_mgr_create_tex2d(const texture_create_desc<texture_2d_size>& desc, const texture_data_desc& data);
		...
		R_EXPORT void texture_mgr_destroy_tex2d(texture2d_t id);
		...
		R_EXPORT void texture_mgr_resize(texture2d_t id, const math::vec2& size);
		R_EXPORT void texture_mgr_resize(texture_3d_t id, const math::vec3& size);

		R_EXPORT void texture_mgr_get_desc(texture2d_t id, texture_create_desc<texture_2d_size>* desc);
		...
		R_EXPORT ptr texture_mgr_tex2d_map(texture2d_t id, u32 mip_level = 0);
		...
		R_EXPORT void texture_mgr_tex2d_unmap(texture2d_t id);
		R_EXPORT void texture_mgr_tex3d_unmap(texture2d_t id);
		...
		R_EXPORT void texture_mgr_tex2d_gen_mipmap(texture2d_t id);
		...
		R_EXPORT texture2d_t texture_mgr_get_white_dummy_tex2d();
	}
}