...
//          new WebModule().Setup(registry);
//          var serviceProvider = registry.Build();
//          var wndMgr = serviceProvider.Get<IWindowManager>();
//          var window = wndMgr.Create(new WindowCreationInfo() { WindowInstance = "#canvas" });
//          window.GetNativeWindow(out var nativeWnd);
//          
//          Console.WriteLine("Selector: "+nativeWnd.CanvasSelector);
