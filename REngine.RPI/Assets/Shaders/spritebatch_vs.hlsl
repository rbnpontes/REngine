...
void main(in uint vertId : SV_VertexID, out PSInput input) 
{
	...
	pos_vertices[0] = float4(-1.0, +1.0, 0.0, 0.0);
	pos_vertices[1] = float4(-1.0, -1.0, 0.0, 1.0);
	pos_vertices[2] = float4(+1.0, +1.0, 1.0, 0.0);
